...
public class QueryDemo implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("findByCountryContains" + regionRepository.findByCountryContaining("United"));
        ...
        System.out.println("findTopByCountryContainsOrderByRegion" + regionRepository.findTopByCountryContainsOrderByRegion("Canada"));
