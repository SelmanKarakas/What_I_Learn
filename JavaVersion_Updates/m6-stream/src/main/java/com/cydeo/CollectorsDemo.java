...
public class CollectorsDemo {
    ...
    public static void main(String[] args) {
        ...
        //avarageingInt(ToIntFunction) returns the avarage of the integers passed values
        Double calorieAvarage = DishData.getAll().stream()
                .collect(Collectors.averagingInt(Dish::getCalories));
        System.out.println(calorieAvarage);
        ...
        //partitioningBy(): is used to partition a stream of object (or a set of elements( based on a give predicate.
        Map<Boolean,List<Dish>> veggieDish = DishData.getAll().stream()
                .collect(Collectors.partitioningBy(Dish::isVegetarian));
        System.out.println(veggieDish);

        //groupingBy(); is used for grouping object by some property and sorting results in a Map instance
